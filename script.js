document.addEventListener('DOMContentLoaded', () => {
  ...
  function switchProdSubtab(subtabId) {
    ...
    document.getElementById(`${subtabId}-prodsubtab`).style.display = 'block';
  ...
  function switchReportSubtab(subtabId) {
    ...
    document.getElementById(`${subtabId}-reportsubtab`).style.display = 'block';
  ...
  addMaterialBtn.addEventListener('click', () => {
    ...
    materialItem.className = 'material-item flex gap-3 items-end';
